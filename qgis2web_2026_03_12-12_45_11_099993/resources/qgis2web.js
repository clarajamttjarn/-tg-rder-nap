...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3006',
            //extent: [283893.000000, 231225.669582, 2419021.518942, 7596522.000000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([220078.533437, 6429643.304945, 842949.364246, 6823449.941916], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Webbgränssnitt test</h2>';
        return titleElement;
    })(),
